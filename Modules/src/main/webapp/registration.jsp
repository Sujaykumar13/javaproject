...
<header class="bg-dark text-white">
    <div class="d-flex justify-content-between align-items-center p-3">
        ...
        <div>
            <button type="button" class="btn btn-info mr-2"><a href="login" style="color: white;">Log in</a></button>
    ...
    <form action="formdata" method="post" onclick="form()"
        ...
        <div class="card p-4 w-100" style="max-width: 600px;">
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Enter first name" class="form-control" name="firstName" id="fName" onchange="fNameValidation()" required>
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Enter Last name" class="form-control" name="lastName" id="lName" onchange="lNameValidation()" required>
            ...
            <div class="form-group">
                <label>Email</label>
                <input type="email" placeholder="Enter Email" class="form-control" name="emailId" id="emailIdd" onchange="checkEmail()" required>
            ...
            <div class="form-group">
                ...
                <input type="number" placeholder="Enter mobile number" class="form-control" name="contactNumber" id="contactNo" onchange="phonee()" required>
            ...
            <div class="form-group">
                <label>city</label>
                <input type="text" placeholder="Enter cityName" class="form-control" name="city" id="cityName" onchange="cityNamee()" required>
            ...
            <div class="form-group">
                ...
                <input type="password" placeholder="Enter password" class="form-control" name="password" id="pasword" onchange="passwordd()" required>
