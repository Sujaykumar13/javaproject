...
public class CanaraAtm implements Atm{
    ...
    public int createPin(int accNo, int pin) {
        if(this.accNo==accNo)
        {
            System.out.println("canara bank account pin generated");
            this.pin=pin;
        }
        else {
    ...
    public int changePin(int accNo, int changePin) {
        if(this.accNo==accNo)
        {
            System.out.println("canara bank account pin changed");
            pin=changePin;
        }
        else {
            System.out.println("account number mismatched");
    ...
    public int withdraw(int pin, int cash) {
        if(ammount>=cash)
        {
            System.out.println("cash withdraw from canara atm");
    ...
    public int deposit(int accNo, int pin, int cash) {
        if(this.accNo==accNo)
        {
            System.out.println("cash deposit from canara atm");
            ammount=ammount+cash;
        }
        else {
            System.out.println("account number mismatched");
    ...
    public String statement(int pin) {
        ...
        return "statement generated for "+accNo+"in canara atm";
    }
}
