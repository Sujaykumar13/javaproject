...
public class CanaraBank implements Bank{
    ...
    public String createAccount(String name,int accNo) {
        System.out.println("Canara bank account is created");
        this.accNo=accNo;
        this.name=name;
        return "Account created successfully in Canara bank with name"+name+" and account number"+accNo;
    }
    ...
    public String closeAccount(int accNo) {
        if(this.accNo==accNo)
        {
            System.out.println("account close successfully canara bank");
        }
        else{
            System.out.println("wrong account");
        }
        return "account close successfully in canara bank";
    }
}
