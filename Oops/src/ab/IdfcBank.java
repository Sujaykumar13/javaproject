...
public class IdfcBank implements Bank{
    ...
    public String createAccount(String name,int accNo) {
        System.out.println("Idfc bank account is created");
        this.accNo=accNo;
        this.name=name;
        return "Account created successfully in Idfc bank with name"+name+" and account number"+accNo;
    }
    ...
    public String closeAccount(int accNo) {
        if(this.accNo==accNo)
        {
            System.out.println("account close successfully in Idfc bank");
        }
        else{
            System.out.println("wrong account");
        }
        return "account close successfully in Idfc bank";
    }
}
