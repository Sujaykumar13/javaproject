      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="branchSelect" name="branchName" onchange="bikeSelectValidation()" required>
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="bikeSelect" name="bikeName" onchange="bikeSelectValidation()" required>
    ...
    <div class="container my-4">
      <div class="row text-white">
        ...
        <div class="col-md-2 mb-4">
          <div class="card text-center shadow" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
            <div class="card-body">
        ...
        <!-- Active -->
        <div class="col-md-2 mb-4">
          <div class="card text-center shadow" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
            <div class="card-body">
        ...
        <!-- Inactive -->
        <div class="col-md-2 mb-4">
          <div class="card text-center shadow" style="background: linear-gradient(135deg, #757f9a 0%, #d7dde8 100%);">
            <div class="card-body">
        ...
        <div class="col-md-3 mb-4">
          <div class="card text-center shadow" style="background: linear-gradient(135deg, #f7971e 0%, #ffd200 100%);">
            <div class="card-body">
        ...
        <!-- Models -->
        <div class="col-md-3 mb-4">
          <div class="card text-center shadow" style="background: linear-gradient(135deg, #00c6ff 0%, #0072ff 100%);">
            <div class="card-body">
  ...
  <div class="row">
    <c:forEach items="${showroomWithBikes}" var="entry">
      <div class="col-sm-12 col-md-6 col-lg-4 mb-4 d-flex align-items-stretch">
        <div class="card w-100 border-0 shadow-lg showroom-card transition-all" style="border-radius: 15px; overflow: hidden;">

          <!-- Gradient Header -->
          <div class="card-header text-white text-center" style="background: linear-gradient(135deg, #232526, #414345);">
            ...
            <div>
              ...
              <ul class="list-group list-group-flush">
                <c:forEach items="${entry.bikeNames}" var="bikeName">
                  <li class="list-group-item bg-transparent px-0 py-1 border-0 text-dark">
                    <i class="fa fa-motorcycle mr-2 text-info"></i>${bikeName}
                  </li>
                </c:forEach>
              </ul>
            </div>
